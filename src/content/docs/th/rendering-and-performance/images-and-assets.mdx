...
export const quizImg = [
  ...
  },
  {
    ...
    options: [
      ...
      'domain ของตัวเองต้องถูก list เป็น authorized ใน Astro config (`image.domains` / `image.remotePatterns`)',
      'ต้องเล็กกว่า 1KB',
      'ต้องเป็น SVG',
    ],
    answer: 1,
