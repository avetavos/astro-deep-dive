...
description: 'route ที่ไม่ใช่ HTML — APIRoute handler ที่ return Response, อ่าน params และ request body, static vs on-demand endpoint และต่างจาก Actions อย่างไร'
sidebar:
  order: 3
---
